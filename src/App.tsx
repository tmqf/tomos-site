...
function App() {
    ...
    <div className="App bg-base text-white sm:h-[241%] md:h-[169%] lg:h-[169%]">
        <div className="grid grid-rows-[50em_minmax(50em,_1fr)] text-lavender">
            <div className="flex flex-row items-stretch sm:flex-col md:flex-col lg:flex-row">
                <div className="sm:w-screen md:w-screen lg:w-[55%] font-['Verdana'] text-center sm:md:pt-[50px] md:pt-[50px] lg:pt-[220px] select-none sm:text-[9.5em] md:text-[9.5em] lg:text-[12em]">
                ...
                <div className="sm:w-screen md:w-screen lg:w-[45%] select-none sm:w-screen md:w-screen text-center">
                    <p className="sm:text-[0.7em] md:text-[0.73em] lg:text-[1em]">
                        ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣀⣤⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
                        ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠐⣿⣿⣷⡄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
                        ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣿⣿⣿⣿⡄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
                        ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢻⣿⣿⣿⣿⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
                ...
                <div className="h-screen">
                    <div className="h-[50%] pt-[5%] mx-[5%]">
                        ...
                        <p className="text-ellipsis text-center sm:text-[1em] md: text-[1em] lg:text-[1.5em] leading-relaxed">
                            This website was purely made <textcss className="font-bold text-blue">to show what I am making or have made.</textcss><br/>
                            This is also <textcss className="font-bold text-blue">one of two websites I have made with a framework,</textcss> so if it sucks, I'm sorry...<br/>
                            ...
                            If you have any problems with the site or any suggestions <textcss className="font-bold text-blue">you may add me on Discord</textcss> down below.<br/>
                    ...
                    <div className="h-[30%] mx-[5%]">
                        <p className="pt-[50px] text-ellipsis text-center sm:text-[1em] md: text-[1em] lg:text-[1.5em] leading-relaxed">
