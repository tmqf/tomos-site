...
function Languages() {
    return (
        <div className="Languages bg-base text-white sm:h-[241%] md:h-[169%] lg:h-[169%]">

            <Helmet><title>tomos - Languages</title></Helmet>
            ...
            <div className="grid grid-rows-[50em_minmax(50em,_1fr)] text-lavender">
                ...
                <div className="flex flex-row items-stretch flex-col sm:flex-col md:flex-col lg:flex-row">
                    <div className="w-screen sm:w-screen pt-[25px] text-[4em] md:w-screen lg:w-[55%] font-['Verdana'] text-center sm:pt-[50px] md:pt-[50px] lg:pt-[220px] select-none sm:text-[7.5em] md:text-[7.5em] lg:text-[10em]">

                        <span className="font-bold hover:text-[1.5em] hover:animate-borderColour hover:transition-all duration-500">l</span>
                        <span className="font-bold hover:text-[1.5em] hover:animate-borderColour hover:transition-all duration-500">a</span>
                        <span className="font-bold hover:text-[1.5em] hover:animate-borderColour hover:transition-all duration-500">n</span>
                        <span className="font-bold hover:text-[1.5em] hover:animate-borderColour hover:transition-all duration-500">g</span>
                        <span className="font-bold hover:text-[1.5em] hover:animate-borderColour hover:transition-all duration-500">u</span>
                        <span className="font-bold hover:text-[1.5em] hover:animate-borderColour hover:transition-all duration-500">a</span>
                        <span className="font-bold hover:text-[1.5em] hover:animate-borderColour hover:transition-all duration-500">g</span>
